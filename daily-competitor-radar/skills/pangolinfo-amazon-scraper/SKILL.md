...
Scrape Amazon product data via Pangolinfo's APIs. Returns parsed JSON with product details, search results, rankings, reviews, and more across 13 Amazon regions.
...
- **Pangolinfo account** at [pangolinfo.com](https://pangolinfo.com/?referrer=clawhub_amz)
...
```bash
python3 scripts/pangolinfo.py --content B0DYTF8L2W --mode amazon --site amz_us
```
...
```bash
python3 scripts/pangolinfo.py --content "toys" --parser amzNewReleases --site amz_us
```

### 5. Category Products

```bash
python3 scripts/pangolinfo.py --content "172282" --parser amzProductOfCategory --site amz_us
```

### 6. Seller Products

```bash
python3 scripts/pangolinfo.py --content "A1B2C3D4E5" --parser amzProductOfSeller --site amz_us
```

### 7. Follow Seller (Other Seller Options)

```bash
python3 scripts/pangolinfo.py --asin B0G4QPYK4Z --parser amzFollowSeller --site amz_us
```

### 8. Variant ASIN (Product Variants)

```bash
python3 scripts/pangolinfo.py --asin B0G4QPYK4Z --parser amzVariantAsin --site amz_us
```

### 9. Product Reviews

```bash
python3 scripts/pangolinfo.py --content B00163U4LK --mode review --site amz_us --filter-star critical
```
...
```bash
python3 scripts/pangolinfo.py --url "https://www.amazon.com/dp/B0DYTF8L2W" --mode amazon
```
...
See [references/error-codes.md](references/error-codes.md) for error code documentation.
