...
# Convert MSYS/Cygwin paths to Windows-native for Python sys.path
if command -v cygpath >/dev/null 2>&1; then
  SCRIPT_DIR_PY="$(cygpath -w "$SCRIPT_DIR")"
else
...
run_test "asin-uppercase" $PYTHON -c "
import sys; sys.path.insert(0, r'$SCRIPT_DIR_PY')
